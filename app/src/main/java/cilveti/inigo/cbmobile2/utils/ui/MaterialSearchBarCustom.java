 ...
 */
public class MaterialSearchBarCustom extends RelativeLayout implements View.OnClickListener,
    ...
    public static final int BUTTON_FILTERS = 4;
    ...
    public MaterialSearchBarCustom(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public MaterialSearchBarCustom(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public MaterialSearchBarCustom(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(AttributeSet attrs) {
        ...
        searchIcon.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if(listenerExists()){
                    onSearchActionListener.onButtonClicked(BUTTON_FILTERS);
                }
            }
        });
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.mt_arrow || id == R.id.mt_nav) {
            disableSearch();
